...
export function StackedLayout({
  ...
  return (
    <div className="relative isolate flex min-h-screen w-full flex-col bg-primary dark:bg-zinc-900 lg:bg-primary dark:lg:bg-zinc-950">
      ...
      {/* Content */}
      <main className="flex flex-1 flex-col pb-4 lg:px-4">
        <div className="dark:lg:ring-white/10c flex min-h-full flex-1 grow lg:rounded-lg lg:bg-white lg:shadow-sm lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900">
          {children}
        </div>
      </main>
    </div>

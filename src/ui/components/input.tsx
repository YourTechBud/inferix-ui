  ...
  return (
    <span
      ...
      className={clsx([
        ...
        'dark:before:hidden',
        // Focus ring
        'sm:after:focus-within:ring-primary-green after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent sm:after:focus-within:ring-2',
        // Disabled state
